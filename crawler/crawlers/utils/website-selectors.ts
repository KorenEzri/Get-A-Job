export const websiteSelectors = {
  glassdoor: {
    selectors: {
      usernameSelector: "input[data-test=emailInput]",
      passwordSelector: "input[data-test=passwordInput",
      submitButtonSelector: "button[type=submit]",
      jobsButtonSelector: "a[data-test=site-header-jobs]",
      jobsSearchInputSelector: "input[data-test=search-bar-keyword-input]",
